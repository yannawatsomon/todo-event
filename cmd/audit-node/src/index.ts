...
async function main(): Promise<void> {
  ...
  //   }
  async function handleEvent(msg: RabbitMessage): Promise<void> {
  ...
  console.log(
    `[audit] subscribed to exchange="${EXCHANGES.task}" queue="${QUEUES.auditTask}"`,
  );
  ...
  console.log(
    `[audit] subscribed to exchange="${EXCHANGES.onboarding}" queue="${QUEUES.auditUser}"`,
  );
